    ...
    if (reponse.value.sansAccent().toUpperCase().replaceAll(" ","").includes(REPONSE)) {
        nextPlace.innerHTML = `
            ...
            <div class="box" id="box">
                <img src="../src/img/banque/indice.png" alt="presentation.png" id="infoImg">
                <img src="../src/img/banque/indice2.png" alt="presentation.png" id="infoImg">
            </div>
			`
		indice.innerHTML = `
     ...
     <img src="../src/img/global/folder2.png" class="folder-img"> ????
      <img src="../src/img/global/folder2.png" class="folder-img"> ????
       <img src="../src/img/global/folder2.png" class="folder-img"> ????
        <img src="../src/img/global/folder2.png" class="folder-img"> ????
         <img src="../src/img/global/folder2.png" class="folder-img"> ????
        9 <img src="../src/img/global/folder2.png" class="folder-img"> Xigd
           <img src="../src/img/global/folder2.png" class="folder-img"> ????
            <img src="../src/img/global/folder2.png" class="folder-img"> ????
             <img src="../src/img/global/folder2.png" class="folder-img"> ????
              <img src="../src/img/global/folder2.png" class="folder-img"> ????
