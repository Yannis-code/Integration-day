...
formulaire.addEventListener("submit", e => {
    ...
    if (reponse.value.sansAccent().toUpperCase().replaceAll(" ","").includes(REPONSE)) {
        nextPlace.innerHTML = `
			<h2>Lieu suivant</h2>
			<audio autoplay controls><source src="../src/audio/cezeaux.mp3"></audio>
            <div class="box" id="box">
                <img src="../src/img/polytech/indice2.png" alt="presentation.png" id="infoImg">
            </div>
			`
		indice.innerHTML = `
            ...
            <img src="../src/img/global/folder2.png" class="folder-img"> ????
             <img src="../src/img/global/folder2.png" class="folder-img"> ????
              <img src="../src/img/global/folder2.png" class="folder-img"> ????
               <img src="../src/img/global/folder2.png" class="folder-img"> ????
                <img src="../src/img/global/folder2.png" class="folder-img"> ????
              16 <img src="../src/img/global/folder2.png" class="folder-img"> FZKd
                  <img src="../src/img/global/folder2.png" class="folder-img"> ????
                   <img src="../src/img/global/folder2.png" class="folder-img"> ????
                    <img src="../src/img/global/folder2.png" class="folder-img"> ????
